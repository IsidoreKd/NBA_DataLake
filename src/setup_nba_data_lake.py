...
bucket_name = "Isi-D-sports-analytics-data-lake"  # Change to a unique S3 bucket name
glue_database_name = "Isi-D-glue_nba_data_lake"
athena_output_location = f"s3://{bucket_name}/athena-results/"

# Sportsdata.io configurations (loaded from .env)
api_key = "1ae60e9990e346678193a5b0dd665549"  # Get API key from .env
nba_endpoint = "https://api.sportsdata.io/v3/nba/scores/json/AllTeams"  # Get NBA endpoint from .env
